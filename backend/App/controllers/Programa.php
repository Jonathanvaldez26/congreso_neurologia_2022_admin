            ...
            <div class="modal fade" id="editar-curso{$datos['id_curso']}" role="dialog" aria-labelledby="" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="time" class="form-control" id="horario_transmision" name="horario_transmision" placeholder="Horario transmisión" value="{$datos['horario_transmision']}" required>
                    </div>
