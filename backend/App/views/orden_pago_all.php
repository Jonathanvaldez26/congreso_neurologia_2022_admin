...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark">Ordenes de Pago</a></li>
                </ol>
            </nav>
    ...
    <div class="container-fluid py-3 col-md-12">
        ...
        <br>
        <a href="/OrdenPago/Add" type="button" class="btn btn-primary btn-sm">Nuevo</a>
                ...
                <div class="table-responsive">
                    <table class="table align-items-center mb-0">
                        ...
                        <tr>
                            ...
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Fecha de Alta</th>
