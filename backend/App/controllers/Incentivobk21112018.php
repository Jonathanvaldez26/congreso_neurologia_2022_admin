...
html;
    ...
    View::render('incentivos_colaborador');
  }

  public function alertasPlataforma($horasExtra, $domingoProcesos, $domingoLaborado, $listaIncentivos, $listaIncentivosResumen, $cantidadIncentivos, $ubicacion){
...
html;
    ...
    $showTextBtnActualizar = ( count($domingoProcesos)>0 || count($domingoLaborado)>0) ? "Actualizar datos" : "Agrear Valores";
    $accionesComplementarias = ( count($domingoProcesos)>0 || count($domingoLaborado)>0) ? "updateDomingos" : "addDomingos";
    $btnAccionesComplementarias = ( count($domingoProcesos)>0 || count($domingoLaborado)>0) ? "btn-success" : "btn-info";
