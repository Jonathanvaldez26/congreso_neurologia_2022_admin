...
<div class="right_col">
  <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
    <div class="panel panel-default">
      <div class="x_title">
        <br><br>
        <h1> Gestion de Periodos <?php echo $tipoPeriodo; ?></h1>
        <div class="clearfix"></div>
      </div>
      <form name="all" id="all" action="/Empresa/delete" method="POST">
        <div class="panel-body" <?php echo $visible; ?>>
          <a href="/AdminPeriodo/add" type="button" class="btn btn-primary btn-circle" <?= $agregarHidden?>><i class="fa fa-plus"> <b>Nuevo Periodo</b></i></a>
            ...
            <table class="table table-striped table-bordered table-hover" id="muestra-cupones">
              <thead>
                <tr>
                  ...
                  <th>Tipo</th>
                  <th>Estatus</th>
                  <td <?php echo $control; ?>>Acciones</td>
                </tr>
              </thead>
              <tbody>
                <?= $tabla; ?>
