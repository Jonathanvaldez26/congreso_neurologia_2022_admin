...
<div class="right_col">
  <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
    <div class="panel panel-default">
      <div class="x_title">
        <br><br>
        <h1> Catálogo de Gestión de Puestos</h1>
        <div class="clearfix"></div>
      </div>
      <form name="all" id="all" action="/Puesto/delete" method="POST">
        <div class="panel-body" <?php echo $visible; ?>>
          <a href="/Puesto/add" type="button" class="btn btn-primary btn-circle" <?= $agregarHidden?>><i class="fa fa-plus"> <b>Nuevo puesto</b></i></a>
