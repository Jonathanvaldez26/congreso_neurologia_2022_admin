...
<div class="right_col">
  <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
    <div class="panel panel-default">
      <div class="x_title">
        <br><br>
        <h1> Catálogo de Gestión de Incidencias</h1>
        <div class="clearfix"></div>
      </div>
      <form name="all" id="all" action="/Incidencias/delete" method="POST">
        <div class="panel-body">
          <a href="/Incidencias/add" type="button" class="btn btn-primary btn-circle" <?= $agregarHidden?>><i class="fa fa-plus"> <b>Nueva incidencia</b></i></a>
            ...
            <table class="table table-striped table-bordered table-hover" id="muestra-cupones">
              <thead>
                <tr>
                  ...
                  <th>Identificador Incidencia</th>
                  <th>Nombre</th>
