...
sql;
    ...
    public function getValoresNoHorasExtra($data){
        $mysqli = Database::getInstance();
        $query=<<<sql
...
sql;
    ...
    public function getDomingoProcesosLaborado($data){
        $mysqli = Database::getInstance();
        $query1=<<<sql
        SELECT * FROM prorrateo_domigo_procesos WHERE catalogo_colaboradores_id = :catalogo_colaboradores_id AND prorrateo_periodo_id = :prorrateo_periodo_id
sql;
        $query2=<<<sql
        SELECT * FROM prorrateo_domigo_laborado WHERE catalogo_colaboradores_id = :catalogo_colaboradores_id AND prorrateo_periodo_id = :prorrateo_periodo_id 
sql;
        $result1 = $mysqli->queryOne($query1, array(":catalogo_colaboradores_id"=>$data->_catalogo_colaboradores_id, ":prorrateo_periodo_id"=>$data->_prorrateo_periodo_id));
        $result2 = $mysqli->queryOne($query2, array(":catalogo_colaboradores_id"=>$data->_catalogo_colaboradores_id, ":prorrateo_periodo_id"=>$data->_prorrateo_periodo_id));

        return (!empty($result1)) ? $result1['domingo_procesos'] : $result2['domingo_laborado'];
    }
