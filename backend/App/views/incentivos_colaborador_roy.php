						...
						<div class="x_content">
							...
							<div class="col-xs-3">
								<ul class="nav nav-tabs tabs-left">
									...
									<li class=""><a href="#domingos" data-toggle="tab" aria-expanded="false">Domingo ROY</a></li>
															...
															<div class="col-md-12 col-sm-12 col-xs-12">
																<div class="x_panel">
																	<div class="row">
																		...
																		<div class="col-md-4 col-sm-4 col-xs-4">
																			<div class="form-group">
																				<label class="control-label col-md-12 col-sm-12 col-xs-12" for="descripcion">Domingo Especial </label>
																				<div class="col-md-12 col-sm-12 col-xs-12" style="text-align: center;">
																					<input name="domingoEspecial" id="domingoEspecial" type="checkbox" data-on-text="SI" data-off-text="NO" value="<?php echo $domingoEspecial ?>" <?php echo $checkdomingoEspecial; ?> >
																				</div>
																				<div class="col-md-12 col-sm-12 col-xs-12" style="text-align: center;"><?php echo $domingoEspecial; ?></div>
																			</div>
																		</div>
