...
<div class="right_col">
  <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
    <div class="x_panel tile fixed_height_240">
      <div class="x_title">
        <br><br>
        <h1><small> Editar Motivo de Baja</small></h1>
        <div class="clearfix"></div>
      </div>
      <div class="x_content">
        <form class="form-horizontal" id="edit" action="/Motivobajas/motivobajaEdit" method="POST">
          <div class="form-group ">

            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nombre">Nombre <span class="required">*</span></label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" name="nombre" id="nombre" class="form-control col-md-7 col-xs-12" placeholder="Nombre del motivo de baja" value="<?php echo $motivobajas['nombre'];?>">
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <textarea class="form-control" name="descripcion" id="descripcion" placeholder="Descripci&oacute;n del motivo"><?php echo $motivobajas['descripcion'];?></textarea>
              </div>
            </div>
            ...
            <input type="hidden" name="catalogo_motivo_baja_id" id="catalogo_motivo_baja_id" value="<?php echo $motivobajas['catalogo_motivo_baja_id'];?>">
