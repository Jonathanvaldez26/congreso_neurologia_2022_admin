...
html;
	...
	public function semanales(){
	    ...
	    if($user['perfil_id'] == 6){
	        ...
	        $tituloVista = "Incidencia propias <b>" . strtoupper($user['nombre_planta']) . "</b> - depto. <b>" . strtoupper($user['nombre']) . "</b>";
	      	...
	      	if($user['perfil_id'] == 2 ){ // Si el usuario personal
	      		$val = 6;
	        	$tituloVista = "Incidencia de TODAS LAS PLANTAS ";
	      	}
		}
		...
		View::set('form',"/Incidencia/semanales/");
	...
	public function quincenales(){
		...
		View::set('form',"/Incidencia/quincenales/");
		View::set('header',$this->_contenedor->header($this->getHeader()));
		View::set('footer',$this->_contenedor->footer($this->getFooter()));
		View::render("incidencia_abierta");
	}
	...
	public function historicosQuincenales(){
		...
		View::set('form',"/Incidencia/historicosQuincenales/");
		View::set('header',$this->_contenedor->header($this->getHeader()));
		View::set('footer',$this->_contenedor->footer($this->getFooter()));
		View::render("incidencia_historicas");
  }
	...
	public function propiosQuincenalesHistoricos(){
		...
		View::set('form',"/Incidencia/propiosQuincenalesHistoricos/");
		View::set('header',$this->_contenedor->header($this->getHeader()));
		View::set('footer',$this->_contenedor->footer($this->getFooter()));
		View::render("incidencia_historicas");
	}
	...
	public function propiosSemanales(){
		...
		View::set('form',"/Incidencia/propiosSemanales/");
		View::set('header',$this->_contenedor->header($this->getHeader()));
		View::set('footer',$this->_contenedor->footer($this->getFooter()));
		View::render("incidencia_abierta");
  	}
	...
	public function propiosQuincenales(){
		...
		View::set('form',"/Incidencia/propiosQuincenales/");
		View::set('header',$this->_contenedor->header($this->getHeader()));
		View::set('footer',$this->_contenedor->footer($this->getFooter()));
		View::render("incidencia_abierta");
	}
