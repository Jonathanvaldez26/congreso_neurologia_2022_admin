                ...
                <div class="card-body pt-0">
                    ...
                    <div class="form-group row">
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                <input id="email" name="email" class="form-control" type="email" placeholder="ejemplo@grupolahe.com" onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-6">
                            ...
                            <div class="input-group">
                                <input id="sitio_web" name="sitio_web" class="form-control" type="text" placeholder="www.grupolahe.com" required="required" onfocus="focused(this)" onfocusout="defocused(this)">
                            </div>
                        </div>
                    </div>
                    <br>
