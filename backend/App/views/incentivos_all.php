...
<div class="right_col">
	<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
		<div class="panel panel-default">
			<div class="x_title">
				<br><br>
				<h1> Catálogo de Gestión de Incentivos</h1>
				<div class="clearfix"></div>
			</div>
			<form name="all" id="all" action="/Incentivos/delete" method="POST">
				<div class="panel-body">
					<a href="/Incentivos/add" type="button" class="btn btn-primary btn-circle" <?= $agregarHidden?>><i class="fa fa-plus"> <b>Nuevo incentivo</b></i></a>
