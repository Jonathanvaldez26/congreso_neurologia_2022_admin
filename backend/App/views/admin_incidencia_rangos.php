...
<div class="right_col">
  <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
    <div class="x_panel tile fixed_height_240">
      ...
      <div class="x_content">
        <form class="form-horizontal" id="edit" method="POST" action="/AdminIncidencia/rangoFechas">
          <div class="form-group ">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12">
                <br>
                <button class="btn btn-success col-md-5 col-sm-5 col-xs-5" id="btnAdd" type="submit">Buscar</button>
                <a  href="/AdminIncidencia/" class="btn btn-danger col-md-5 col-sm-5 col-xs-5">Regresar</a>
              </div>
            </div>

            <input type="hidden" name="catalogo_colaboradores_id" id="catalogo_colaboradores_id" value="<?php echo $catalogo_colaboradores_id ?>">
            <input type="hidden" name="numero_empleado" id="numero_empleado" value="<?php echo $numero_empleado ?>">
